    ...
    <div dir="rtl" style={{ padding: '20px', paddingBottom: '90px', maxWidth: '600px', margin: '0 auto', fontFamily: 'Heebo, sans-serif' }}>
      ...
      <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', marginBottom: '20px', boxShadow: '0 4px 10px rgba(0,0,0,0.05)', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <a href="https://links.payboxapp.com/e308WYB4JUb" target="_blank" rel="noreferrer" style={{ backgroundColor: '#00c6e8', color: 'white', padding: '16px', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', fontSize: '1.3rem', boxShadow: '0 2px 4px rgba(0,198,232,0.3)' }}>
            תרומה ב- PayBox
          </a>
